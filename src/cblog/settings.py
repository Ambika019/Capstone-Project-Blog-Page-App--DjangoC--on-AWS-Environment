...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.cx0lo1ad77ht.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'awscapstoneambikablog' # please enter your s3 bucket name
